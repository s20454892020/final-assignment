...
def getCmdArgs():
  ...
  p = argparse.ArgumentParser(description=("Handle a set of data in geotiff format"))
  # read a string
  p.add_argument("--inDir",dest="inDir",type=str,default='/geos/netdata/oosa/assignment/lvis/2015',help=("Input filename"))
  p.add_argument("--outRoot",dest="outRoot",type=str,default='task2.tif',help=("Output filename"))
